...
export interface PermissonlessCreatorInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "LENS_HANDLES",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "TOKEN_HANDLE_REGISTRY",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [
      Types.CreateProfileParamsStruct,
  ...
  encodeFunctionData(
    functionFragment: "getHandleCreationPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getHandleLengthMin",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getProfileCreationPrice",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isTrustRevoked",
    values: [PromiseOrValue<string>]
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "ProfileCreationPriceChanged"
  ): EventFragment;
...
export type CreditBalanceChangedEventFilter =
  TypedEventFilter<CreditBalanceChangedEvent>;
...
export type TrustStatusChangedEvent = TypedEvent<
  [string, boolean],
  TrustStatusChangedEventObject
>;

export type TrustStatusChangedEventFilter =
  TypedEventFilter<TrustStatusChangedEvent>;
...
export interface PermissonlessCreator extends BaseContract {
  ...
  callStatic: {
    ...
    createProfileWithHandle(
      ...
      [BigNumber, BigNumber] & { profileId: BigNumber; handleId: BigNumber }
    >;
  ...
  filters: {
    ...
    "HandleCreationPriceChanged(uint256)"(
      newPrice?: null
    ): HandleCreationPriceChangedEventFilter;
    ...
    "ProfileCreationPriceChanged(uint256)"(
      newPrice?: null
    ): ProfileCreationPriceChangedEventFilter;
