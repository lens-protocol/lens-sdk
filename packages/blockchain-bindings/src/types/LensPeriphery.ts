...
export interface LensPeripheryInterface extends utils.Interface {
  ...
  decodeFunctionResult(functionFragment: 'getProfileMetadataURI', data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: 'toggleFollow', data: BytesLike): Result;
  decodeFunctionResult(functionFragment: 'toggleFollowWithSig', data: BytesLike): Result;
