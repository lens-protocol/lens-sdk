...
export function fetchApps(
  client: AnyClient,
  request: AppsRequest,
): ResultAsync<Paginated<App> | Paginated<[]>, UnexpectedError> {
...
): ResultAsync<Paginated<AppFeed> | Paginated<[]>, UnexpectedError> {
...
): ResultAsync<Paginated<AppSigner> | Paginated<[]>, UnexpectedError> {
