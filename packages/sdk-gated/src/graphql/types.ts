...
export type AddressOwningProfileQueryVariables = Exact<{
  profileId?: InputMaybe<Scalars['ProfileId']>;
}>;

export type AddressOwningProfileQuery = {
  __typename?: 'Query';
  profile?: { __typename?: 'Profile'; ownedBy: any } | null;
};

export type GetLatestPublicationForProfileIdQueryVariables = Exact<{
  profileId: Scalars['ProfileId'];
}>;

export type GetLatestPublicationForProfileIdQuery = {
  __typename?: 'Query';
  publications: {
    __typename?: 'PaginatedPublicationResult';
    items: Array<
...
export type GetProfilesForAddressQueryVariables = Exact<{
  address: Scalars['EthereumAddress'];
}>;

export type GetProfilesForAddressQuery = {
  __typename?: 'Query';
  profiles: {
    __typename?: 'PaginatedProfileResult';
    items: Array<{ __typename?: 'Profile'; id: any; handle: any }>;
  };
};
...
export const AddressOwningProfileDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AddressOwningProfile' },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<AddressOwningProfileQuery, AddressOwningProfileQueryVariables>;
export const GetLatestPublicationForProfileIdDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetLatestPublicationForProfileId' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'profileId' } },
  ...
  GetLatestPublicationForProfileIdQuery,
  GetLatestPublicationForProfileIdQueryVariables
>;
export const GetProfilesForAddressDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetProfilesForAddress' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<GetProfilesForAddressQuery, GetProfilesForAddressQueryVariables>;
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'PublicationMetadataV2Input' },
            },
          },
        },
      ],
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: 'ObjectField',
                      name: { kind: 'Name', value: 'metadatav2' },
