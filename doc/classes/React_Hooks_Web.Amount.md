...
| :------ | :------ | :------ |
| `T` | extends [`Asset`](../modules/React_Hooks_Web.md#asset) | The [Asset](../modules/React_Hooks_Web.md#asset) type of the amount. |

## Methods

### add

▸ **add**(`amount`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>

Sum of two Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).

#### Parameters

| Name | Type |
| :------ | :------ |
| `amount` | [`Amount`](React_Hooks_Web.Amount.md)<`T`\> |

#### Returns

[`Amount`](React_Hooks_Web.Amount.md)<`T`\>
...
▸ **clone**(`value`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>

Creates an Amount of the same [Asset](../modules/React_Hooks_Web.md#asset) with the new specified `value`.

#### Parameters

| Name | Type |
| :------ | :------ |
| `value` | [`AmountValue`](../modules/React_Hooks_Web.md#amountvalue) |

#### Returns

[`Amount`](React_Hooks_Web.Amount.md)<`T`\>

a new Amount with the same [Asset](../modules/React_Hooks_Web.md#asset) and the new `value`.
...
| Name | Type | Description |
| :------ | :------ | :------ |
| `C` | extends [`Asset`](../modules/React_Hooks_Web.md#asset) | The [Asset](../modules/React_Hooks_Web.md#asset) type to convert to. |
...
▸ **div**(`divisor`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>
...
| Name | Type |
| :------ | :------ |
| `divisor` | [`AmountValue`](../modules/React_Hooks_Web.md#amountvalue) |
...
Equality check for Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
Greater than check for Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
Greater than or equal check for Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
Less than check for Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
Less than or equal check for Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
▸ **mul**(`factor`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>
...
| Name | Type |
| :------ | :------ |
| `factor` | [`AmountValue`](../modules/React_Hooks_Web.md#amountvalue) |
...
▸ **sub**(`amount`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>

Difference of two Amounts of the same [Asset](../modules/React_Hooks_Web.md#asset).
...
Converts the internal value as [BigDecimal](React_Hooks_Web.BigDecimal.md) truncated at the [Asset](../modules/React_Hooks_Web.md#asset) max precision.
...
the internal value as `string` truncated at this Amount [Asset](../modules/React_Hooks_Web.md#asset) max precision.
...
▸ `Static` **erc20**<`T`\>(`asset`, `value`): [`Amount`](React_Hooks_Web.Amount.md)<`T`\>

Creates an Amount of the specified [Erc20](React_Hooks_Web.Erc20.md) with the specified `value`.

#### Type parameters

| Name | Type |
| :------ | :------ |
| `T` | extends [`Erc20`](React_Hooks_Web.Erc20.md)<`T`\> |
...
▸ `Static` **ether**(`value`): [`Amount`](React_Hooks_Web.Amount.md)<[`Ether`](React_Hooks_Web.Ether.md)\>

Creates an [Ether](React_Hooks_Web.Ether.md) Amount with the specified `value`.
...
[`Amount`](React_Hooks_Web.Amount.md)<[`Ether`](React_Hooks_Web.Ether.md)\>
...
▸ `Static` **matic**(`value`): [`Amount`](React_Hooks_Web.Amount.md)<[`Matic`](React_Hooks_Web.Matic.md)\>

Creates an [Matic](React_Hooks_Web.Matic.md) Amount with the specified `value`.
...
[`Amount`](React_Hooks_Web.Amount.md)<[`Matic`](React_Hooks_Web.Matic.md)\>
...
▸ `Static` **usd**(`value`): [`Amount`](React_Hooks_Web.Amount.md)<[`Fiat`](React_Hooks_Web.Fiat.md)\>

Creates an USD [Fiat](React_Hooks_Web.Fiat.md) Amount with the specified `value`.
...
[`Amount`](React_Hooks_Web.Amount.md)<[`Fiat`](React_Hooks_Web.Fiat.md)\>
