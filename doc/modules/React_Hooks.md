...
Amount is a value object representing an amount of given [Asset](React_Hooks.md#asset).
...
| Name | Type |
| :------ | :------ |
| `T` | extends [`Asset`](React_Hooks.md#asset) |
...
▸ **erc20**(`«destructured»`): [`Erc20`](../classes/React_Hooks.Erc20.md)
...
| Name | Type |
| :------ | :------ |
| `«destructured»` | [`Erc20Info`](React_Hooks.md#erc20info) |
